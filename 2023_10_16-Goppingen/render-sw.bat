...
"cmd.exe" /c ""C:\Users\ilx\wrk\ffmpeg\ffmpeg.exe" -loglevel level+error -i "%2.avs" -strict -1 -f yuv4mpegpipe - | "C:\users\ilx\wrk\x265\x265.exe" --crf 31 --preset=slow --sar 1:1 -o "%1\result\%2.h265" --y4m -"
